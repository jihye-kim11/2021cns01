...
public class MainActivity extends AppCompatActivity {
    ...
    final private String key = "a-wf2ir5-n9kqnkhfmb";    //API key 변경하기
    final private String token = "vA-gLi8)8V-fjuN0f?";   //token 변경하기
        ...
        try {
            mqttAndroidClient.connect(mqttConnectOptions,null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    subscribeEvent("Raspberry_Pi","tst_pi", "distance");//test_pi
...
//                    subscribeEvent("Raspberry_Pi");
        ...
        openButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    data.put("state" , "open");
                    publishCommand("Raspberry_Pi","tst_pi","door", data);//test_pi
